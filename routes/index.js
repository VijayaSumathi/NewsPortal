...
>>>>>>> 77c026869d8b6c35c8012b149465e27a46bd15ac
            ...
            .then(function() {
                ...
                fs.unlink(__dirname + '/../public/images/' + res.req.file.filename, function(error) {
                    if (error) {
                        ...
                        compress_images('./public/images/temp/*.{jpg,JPG,jpeg,JPEG,png,svg,gif}', OUTPUT_path, { compress_force: false, statistic: true, autoupdate: true }, false, { jpg: { engine: 'mozjpeg', command: ['-quality', '60'] } }, { png: { engine: 'pngquant', command: ['--quality=20-50'] } }, { svg: { engine: 'svgo', command: '--multipass' } }, { gif: { engine: 'gifsicle', command: ['--colors', '64', '--use-col=web'] } }, function(err) {
                            console.log(err);
